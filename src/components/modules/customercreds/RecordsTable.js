        ...
        <Table className={classes.table} size='small' aria-label='simple table'>
          ...
          <TableBody>
            {orderBy(onscrrecords, columnToSort, sortDirection)
              ...
              .map((obj) => (
                <TableRow key={obj.customer_cred_ID}>
                  ...
                  <TableCell>
                    <div
                      style={tableIconStyle}
                      onClick={onDelete.bind(this, obj.customer_cred_ID)}
                    >
...
const mapStateToProps = (state) => ({
  onscrrecords: state.customercreds.onscrrecords,
  error: state.customercreds.error,
});
